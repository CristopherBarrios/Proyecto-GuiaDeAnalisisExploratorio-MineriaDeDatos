...
ggplot(data = divorcios, aes(x = AÑOREG)) + 
  ...
  scale_fill_gradient(low = "#DCDCDC", high = "mistyrose3")+
...
qqnorm(divorcios$AÑOREG, col="lightblue3")
qqline(divorcios$AÑOREG, col="salmon3")
```
...
qqnorm(divorciosEdadHom$EDADHOM, col="lightblue3")
qqline(divorciosEdadHom$EDADHOM, col="salmon3")
```
...
qqnorm(divorciosEdadMuj$EDADMUJ, col="lightblue3")
qqline(divorciosEdadMuj$EDADMUJ, col="salmon3")
```
